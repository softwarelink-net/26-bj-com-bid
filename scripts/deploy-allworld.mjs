#!/usr/bin/env node
/**
 * Upload dist/ to project R2 bucket + shared allworld-sites host prefix.
 * (Internal deploy helper — not documented in README.)
 */
...
const siteId = process.argv[2] || '26-bj-com-bid'
const projectBucket = '26-bj-com-bid-assets'
